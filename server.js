...
app.post('/followup', async (req, res) => {
  ...
  try {
    ...
    const userTickers = userAnalysisHistory[sessionId] ? Array.from(userAnalysisHistory[sessionId]) : [];
    let ticker = sessionStore[sessionId].ticker; // Default to most recent ticker
    let messageHistory = []; // Define messageHistory at function scope so it's available throughout the function
  ...
  // Message history was already updated before the API call
